...
const Pin = ({ pin }) => {
  const { image, _id, postedBy, destination, save } = pin;
  ...
  const savePin = (id) => {
    if (!alreadySaved) {
      client
        .patch(id)
        .setIfMissing({ save: [] }) //initialize the array
        .insert("after", "save[-1]", [
          {
  ...
  return (
    <div className="m-2">
      <div
        ...
        className="relative hover:cursor-pointer w-auto hover:shadow-lg rounded-lg overflow-hidden transition-all duration-500 ease-in-out"
      >
        <img
        ...
        />
        {/*if hovering this div will be added */}
        {postHovered && (
          <div
            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2">
                ...
                <a
                  ...
                  download
                  /*this is because once clicked, the element will be downloaded and the page redirected, which I dont want */
