...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full px-8 md:max-w-[500px] md:mx-auto md:mt-[155px]">
        <p className="navText text-center text-spaceMiddle md:heading-5">
          so you want to travel to
        </p>
        <p className="heading-2 text-center md:heading-1">space</p>
        <p className="regularText text-center text-spaceMiddle md:leading-[28px]">
      ...
      <div className="text-center mt-[6rem] flex justify-center">
        <div
          className="w-[150px] h-[150px] subHeading-2 text-black bg-white rounded-full flex justify-center items-center md:w-[242px] md:h-[242px] md:heading-4"
          onClick={() => {
